...
function StatItem({ stat, index, inView }) {
  ...
  return (
    ...
    >
      <div className="w-12 h-12 rounded-2xl bg-[rgba(255,92,0,0.1)] border border-[rgba(255,92,0,0.2)] flex items-center justify-center mx-auto mb-4">
        <Icon size={20} className="text-[#FF5C00]" aria-hidden="true" />
      </div>
      <div className="font-display text-5xl text-white leading-none mb-1">
        {count}
        <span className="text-[#FF5C00]">{stat.suffix}</span>
      </div>
...
export default function About() {
  ...
  return (
    <section id="sobre" className="py-28 relative" aria-labelledby="about-title">
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#FF5C00] opacity-[0.04] blur-[100px] rounded-full" aria-hidden="true" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <div className="glass-card rounded-3xl p-8 relative overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#FF5C00] opacity-10 blur-3xl rounded-full" />

              <div className="relative">
                <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-[#FF5C00] to-[#FFB347] flex items-center justify-center font-display text-white text-3xl mb-6 glow-orange">
                  CT
                </div>
            ...
            {/* Floating badge */}
            <div className="absolute -bottom-4 -right-4 bg-[#FF5C00] text-white rounded-2xl px-5 py-3 shadow-lg">
          ...
          >
            ...
            <div className="flex items-center gap-3 glass-card rounded-2xl px-5 py-4 inline-flex">
              <MapPin size={18} className="text-[#FF5C00] shrink-0" aria-hidden="true" />
              <p className="text-white font-medium text-sm">
                Empresa local.{' '}
                <span className="font-italic-serif text-[#FFB347]">Resultado profissional.</span>
              </p>
            </div>
          </motion.div>
        </div>

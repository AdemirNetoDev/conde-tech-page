    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
          scrolled
            ? 'bg-[#0A0A0F]/90 backdrop-blur-md border-b border-[rgba(255,92,0,0.1)] py-3'
            : 'py-5'
        }`}
        role="banner"
      >
        ...
        >
          ...
          <a
            ...
            className="hidden md:flex items-center gap-2 bg-[#FF5C00] hover:bg-[#FF7A2E] text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-all duration-200 hover:shadow-[0_0_20px_rgba(255,92,0,0.4)]"
        ...
        {open && (
          ...
          >
            <ul className="flex flex-col items-center gap-6" role="list">
              {NAV_LINKS.map((link, i) => (
                ...
                >
                  <button
                    onClick={() => handleNav(link.href)}
                    className="font-display text-4xl text-white hover:text-[#FF5C00] transition-colors cursor-pointer"
                  >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-[#FF5C00] text-white font-semibold px-8 py-4 rounded-full text-lg"

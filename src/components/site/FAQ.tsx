...
function FAQItem({ faq, index }) {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-medium text-white text-base group-hover:text-[#FF5C00] transition-colors duration-200">
          {faq.question}
        </span>
        <div
          className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
            open
              ...
              : 'bg-[rgba(255,255,255,0.05)] text-[#A0A0B0] group-hover:bg-[rgba(255,92,0,0.1)] group-hover:text-[#FF5C00]'
          }`}
          aria-hidden="true"
        >
...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-28 relative" aria-labelledby="faq-title">
      <div className="absolute right-0 top-1/3 w-[400px] h-[400px] bg-[#FF5C00] opacity-[0.04] blur-[100px] rounded-full" aria-hidden="true" />
